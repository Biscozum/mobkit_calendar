...
class MobkitCalendarController extends ChangeNotifier {
  ...
  parseAppointmentModel() {
    ...
    if (appointments.isNotEmpty) {
      ...
      for (var appointment
          in appointments.where((element) => element.appointmentStartDate.isAfter(element.appointmentEndDate))) {
      ...
      if (appointments.isNotEmpty) {
        if (appointments.where((element) => element.recurrenceModel != null).isNotEmpty) {
          withRecurrencyAppointments = appointments.where((element) => element.recurrenceModel != null).toList();
