...
class MobkitCalendarController extends ChangeNotifier {
  ...
  parseAppointmentModel(List<MobkitCalendarAppointmentModel> newAppointments) {
    ...
    if (newAppointments.isNotEmpty) {
      ...
      for (var appointment
          in newAppointments.where((element) => element.appointmentStartDate.isAfter(element.appointmentEndDate))) {
      ...
      if (newAppointments.isNotEmpty) {
        withRecurrencyAppointments = newAppointments.where((element) => element.recurrenceModel != null).toList();
        _appointments.addAll(newAppointments.where((element) => element.recurrenceModel == null).toList());
